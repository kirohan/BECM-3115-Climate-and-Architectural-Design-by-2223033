...
### Slidewise QB Analysis reader
The Slidewise QB Analysis module uses a PDF-faithful page viewer. The 18 lecture-wise reports are rendered from their original PDFs, preserving the designed tables, colours, spacing, notes and page layout. Use **Fit page** for normal reading, **Detail / zoom** on smaller screens, or **Fullscreen** for an individual report page. A collapsed text transcription remains available for accessibility and search.
